...
#### NeuralRGBD ####
@torch.no_grad()
def extract_mesh(query_fn, config, bounding_box, marching_cube_bound=None, color_func = None, voxel_size=None, resolution=None, isolevel=0.0, scene_name='', mesh_savepath='', render_uncert=True):
    '''
    ...
    if len(raw) == 0:
        print("WARN: No data returned from query function. Returning empty mesh.")
